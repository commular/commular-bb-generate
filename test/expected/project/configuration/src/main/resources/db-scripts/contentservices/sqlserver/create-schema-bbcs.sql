    ...
    create table OBJECT_DATA (
        ...
        OBJECT_TYPE_ID numeric(19,0) not null,
        PARENT_ID numeric(19,0),
        CS_ID numeric(19,0),
        RD_ID numeric(19,0) not null,
    ...
    create table OBJECT_TYPE_DEFINITION (
        ...
        contentStreamAllowed nvarchar(255),
        creatable bit,
    ...
    create table PROPERTY_DATA (
        ...
        objectId nvarchar(255) not null,
        PROPERTY_DEFINITION_ID numeric(19,0) not null,
        queryName nvarchar(255),
        value nvarchar(765),
        primary key (id)
    );
    ...
    create table RELATIONSHIPS (
        ...
        targetRepositoryId nvarchar(255) not null,
        targetObjectId nvarchar(255) not null,
