...
INSERT INTO items (discriminator,state,name,parentitemname,parentitemtype,template_id,contextItemName,subtype,type,userid,extendeditem_id,createdtimestamp,lastmodifiedtimestamp, uuid, publicationStatus)
VALUES ('PortalFoundation','INSTANTIATED','[BBHOST]',null,null,null,'[BBHOST]',null,'PORTALFOUNDATION',null,null,now(), now(), '413c44e2-59b8-47b3-997a-427f224b14a7', 'NOT_PUBLISHED');
